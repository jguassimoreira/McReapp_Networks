...
setwd("C:/Users/jguas/Desktop/McReapp/github/McReapp_Networks")
behavDat = read_excel("behavData.xlsx")
motionDat = read_csv("motion_avg_nVols.csv")
hist(outSimCRN)
order(outSimCRN)
...
fullDat = inner_join(behavDat, motionDat)
moCorr = corr.test(fullDat[-1], method = "spearman")
print(moCorr, short = FALSE)
